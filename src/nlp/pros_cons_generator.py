...
class ProsConsGenerator:
    ...
    def confidence(self, value, threshold):
        ...
        score = int(60 + ((value - threshold) / threshold) * 40)
    ...
    def generate(self):
                ...
                output.append(
                    {
                        ...
                        "confidence_pct": self.confidence(row["revenue_cagr_5yr"], 15),
                    }
                )
                ...
                output.append(
                    {
                        ...
                        "confidence_pct": self.confidence(
                            row["operating_profit_margin_pct"], 25
                        ),
                    }
                )
                ...
                output.append(
                    {
                        ...
                        "confidence_pct": self.confidence(row["pat_cagr_5yr"], 20),
                    }
                )
        ...
        if (pd.notna(row["interest_coverage"]) and row["interest_coverage"] > 10) or (
            ...
            output.append(
                {
                    ...
                    "confidence_pct": self.confidence(row["eps_cagr_5yr"], 15),
                }
            )
            ...
            output.append(
                {
                    ...
                    "confidence_pct": self.confidence(row["debt_to_equity"], 2),
                }
            )
        ...
        if (
            ...
            and row["composite_quality_score"] < 50
        ):
